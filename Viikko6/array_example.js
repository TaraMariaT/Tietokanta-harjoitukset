...
// 1. Tulosta taulun tietotyyppi
console.log("bookArrayn tietotyyppi:", typeof bookArray);

// 2. Tulosta koko array
console.log("Koko bookArray:", bookArray);

// 3. Tulosta ensimmäinen rivi
console.log("Ensimmäinen rivi:", bookArray[0]);

// 4. Tulosta ensimmäisen kirjan nimi
console.log("Ensimmäisen kirjan nimi:", bookArray[0].name);

// 5. Tulosta rivien määrä
console.log("Rivien määrä:", bookArray.length);

// 6. Tulosta kaikkien kirjojen nimet
